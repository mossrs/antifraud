    ...
    <div class="container">
        ...
        <div class="fraudBox">
            ...
            <video v-show="videoShow" class="video" controls>
                <source src="/video/网络诈骗.mp4" type="video/mp4">
...
import titleImg from '../../../img/scene02/review/网络诈骗.png';
...
const fraud2 = JSON.parse(sessionStorage.fraud5);
const type = fraud2.fraudType;
...
var isTrue = JSON.stringify(fraud2.fraudResult);
if (isTrue) {
    isTrue = "是"
} else {
    isTrue = "否"
